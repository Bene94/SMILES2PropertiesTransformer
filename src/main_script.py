...
@click.option('--mode', default="NRTL-T", help='Determines the mode: reg: does a regresstion; NRTL: use NRTL model as head, NRLT-T: use NRTL-T model as head')
...
@click.option('--data', default='data_x_t', help='Location of dataset')
