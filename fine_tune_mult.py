...
def main(model_name, data_path, batch_size, epochs, lr, weight_decay, cuda, mult):
    ...
    for i in range(0,outer_loop):
        ...
        temp_val_loss, temp_val_prediction, temp_val_target = evaluate(model, val_0_data, wandb, epoch, config, 'val_0')
        ...
        temp_val_loss, temp_val_prediction, temp_val_target = evaluate(model, val_1_data, wandb, epoch, config, 'val_1')
        ...
        temp_val_loss, temp_val_prediction, temp_val_target = evaluate(model, val_2_data, wandb, epoch, config, 'val_2')
